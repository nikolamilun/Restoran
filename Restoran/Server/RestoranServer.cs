        ...
        public bool vratiDataSet(DataSet podaciDataSet)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connString))
                {
                    ...
                    SqlDataAdapter sdaJelo = new SqlDataAdapter("SELECT * FROM jelo", conn);
                    sdaJelo.UpdateCommand = new SqlCommand("UPDATE * FROM Jelo SET id_jela = @id_jela, naziv_jela = @naziv_jela, opis_jela = @opis_jela WHERE id_jela = @id_jela");
                    ...
                    sdaJelo.DeleteCommand = new SqlCommand("DELETE FROM Jelo WHERE id_jela = @id_jela");
                    sdaJelo.DeleteCommand.Parameters.Add("@id_jela", SqlDbType.Int);
                    sdaJelo.DeleteCommand.Parameters["@id_jela"].SourceColumn = "id_jela";

                    SqlDataAdapter sdaMeni = new SqlDataAdapter("SELECT * FROM meni", conn);
                    sdaMeni.UpdateCommand = new SqlCommand("UPDATE Meni SET id_menija = @id_menija, naziv_menija = @naziv_menija, aktivan = @aktivan WHERE id_menija = @id_menija");
                    ...
                    sdaMeni.DeleteCommand = new SqlCommand("DELETE FROM Meni WHERE id_menija = @id_menija");
                    ...
                    SqlDataAdapter sdaSastojci = new SqlDataAdapter("SELECT * FROM sastojci", conn);
                    sdaSastojci.UpdateCommand = new SqlCommand("UPDATE Sastojci SET id_sastojka = @id_sastojka, naziv_sastojka = @naziv_sastojka, opis_sastojka = @opis_sastojka WHERE id_sastojka = @id_sastojka");
                    ...
                    sdaSastojci.DeleteCommand = new SqlCommand("DELETE FROM Sastojci WHERE id_sastojka = @id_sastojka");
                    ...
                    SqlDataAdapter sdaNaMeniju = new SqlDataAdapter("SELECT * FROM naMeniju", conn);
                    sdaNaMeniju.UpdateCommand = new SqlCommand("UPDATE naMeniju SET id_jela = @id_jela, id_menija = @id_menija, cena = @cena WHERE id_jela = @id_jela AND id_menija = @id_menija");
                    ...
                    sdaNaMeniju.DeleteCommand = new SqlCommand("DELETE FROM NaMeniju WHERE id_jela = @id_jela AND id_menija = @id_menija");
                    ...
                    SqlDataAdapter sdaSeSastoji = new SqlDataAdapter("SELECT * FROM seSastoji", conn);
                    sdaNaMeniju.UpdateCommand = new SqlCommand("UPDATE seSastoji SET id_jela = @id_jela, id_sastojka = @id_sastojka, kolicina = @kolicina WHERE id_jela = @id_jela AND id_sastojka = @id_sastojka");
                    sdaNaMeniju.UpdateCommand.Parameters.Add("@id_jela", SqlDbType.Int);
                    sdaNaMeniju.UpdateCommand.Parameters["@id_jela"].SourceColumn = "id_jela";
                    ...
                    sdaNaMeniju.DeleteCommand = new SqlCommand("DELETE FROM NaMeniju WHERE id_jela = @id_jela AND id_sastojka = @id_sastojka");
                    sdaNaMeniju.DeleteCommand.Parameters.Add("@id_jela", SqlDbType.Int);
                    sdaNaMeniju.DeleteCommand.Parameters["@id_jela"].SourceColumn = "id_jela";
